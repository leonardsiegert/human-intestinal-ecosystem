...
var svg = d3.select("#CentralEurope")
  .append("svg")
...
svg.append("text")
    ...
    .text("Bubble chart of CentralEurope PCA loadings");

d3.csv(dataset).then(function(data) {
     // x-axis
  var x = d3.scalePoint()
    .domain(['','PC1','PC2','PC3','PC4'])
    .range([ 0, width-100 ]);
  svg.append("g")
  ...
  var myColor = d3.scaleOrdinal()
    ...
    // Create a tooltip:
  var tooltip = d3.select("#CentralEurope")
    .append("div")
    .style("opacity", 0)
    .attr("class", "tooltip")
