...
svg.append("text")
    ...
    .text("Bubble chart of SouthEurope PCA loadings");

d3.csv(dataset).then(function(data) {
     // x-axis
  var x = d3.scalePoint()
    .domain(['','PC1','PC2','PC3','PC4','PC5','PC6'])
    .range([ 0, width-100 ]);
  svg.append("g")
  ...
  var myColor = d3.scaleOrdinal()
    ...
    // Create a tooltip:
  var tooltip = d3.select("#SouthEurope")
    .append("div")
    .style("opacity", 0)
    .attr("class", "tooltip")
  ...
  svg.selectAll("circle")
    ...
    .enter()
    .append("circle")
      .attr("class", function(d) { return "bubbles bubbles" + d.sign })
